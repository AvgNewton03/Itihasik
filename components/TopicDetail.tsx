...
export const TopicDetail: React.FC<TopicDetailProps> = ({ topicName, onBack, category }) => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const safeGalleryPrompts = details.galleryPrompts || [];
      let galleryTerms: string[] = safeGalleryPrompts.length > 0 ? safeGalleryPrompts : ["detailed close up", "architectural view", "artistic representation"];
    ...
    <div className="min-h-full pb-20 animate-fade-in relative">
        ...
        <div className="relative h-[65vh] w-full overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-16 max-w-7xl mx-auto pb-28 md:pb-16">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mt-6 relative z-10">
